...
NON_USER_ANSWER_MARKERS = (
    ...
    "мы передали ваше обращение специалист",
    "передали ваше обращение специалист",
    "передали информацию специалист",
    ...
    "по представленному вами скриншоту",
    "по вашему скриншоту видно",
    "дополнительные действия не требуется",
    "мы рады, что у вас получилось",
    "проверить наличие сертификата можно",
    "если ты еще не определился, какой именно форум выбрать",
    "если ты ещё не определился, какой именно форум выбрать",
    "что объединяет молодежь россии",
    "что объединяет молодёжь россии",
    "регистрируйтесь на сайте",
    "приходите за своими смыслами",
    "не теряйте продажи",
