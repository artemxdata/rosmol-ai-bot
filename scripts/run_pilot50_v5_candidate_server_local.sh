...
readonly PILOT50_RUNNER_GENERATION="v5"
readonly PILOT50_CANDIDATE_DATASET_ID="pilot50_balanced_v5"
readonly PILOT50_CANDIDATE_PROMPT_VERSION="pilot50-quality-v5"
