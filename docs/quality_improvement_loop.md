...
Запуск дороже 100 рублей или полный Product80 выполняется только после отдельного одноразового
согласования владельца. До старта в согласовании фиксируются точный runtime SHA, название и версия
набора, прогноз стоимости и расчётный верхний budget. Одно согласование нельзя повторно использовать
для другого SHA, набора или попытки. Полный прогон разрешён максимум один раз на release candidate
и максимум один раз за скользящие 24 часа; начатая или оборванная попытка также учитывается.
Автоматические повторы платных прогонов запрещены.
