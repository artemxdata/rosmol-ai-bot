...
`ssh -L 8080:127.0.0.1:80 root@<server>` и локальный адрес админки.
...
**Статус:** ожидает финального gate.  
Release candidate — `fdea1e1`. После успешного reindex, server-local suite и HDE/VK smoke он
допускается к операторскому тесту. При неуспехе сначала классифицируется причина; rollback не
