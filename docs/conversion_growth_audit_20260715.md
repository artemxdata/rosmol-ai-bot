...
> Историческая инструкция: после закрытия D-014 основной командный доступ работает через
> `https://139.100.225.44/admin/kb`. SSH tunnel ниже оставлен только как аварийный fallback.

Аварийный доступ через SSH tunnel:
